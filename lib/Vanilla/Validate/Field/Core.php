 ...
 * @licence 	MIT
 */
abstract class Vanilla_Validate_Field_Core {
	...
	/**
	 * Create a new Validate Field instance.
	 * 
	 * @param 	string 		field name
	 * @return 	Vanilla_Validate_Field
	 */
	public static function factory($name, $label = NULL)
	{
		return new Vanilla_Validate_Field($name);
	}
	 ...
	 * @return 	string|Vanilla_Validate_Field 	getter returns a string and setter returns a Vanilla_Validate_Field
	 */
	 ...
	 * @return 	Vanilla_Validate_Field 	current Vanilla_Validate_Field instance
	 */
	 ...
	 *     $field->format(Vanilla_Validate_Format::EMAIL)
	 * 
	 ...
	 *     $field->rule(Vanilla_Validate_Rule::NOT_EMPTY)
	 *           ->rule(Vanilla_Validate_Rule::MIN_LENGTH, array(4))
	 ...
	 * @return 	mixed|Vanilla_Validate_Field 	getter returns a value of any type and setter returns a Vanilla_Validate_Field
	 */
	...
	public function check($value = NULL)
	{
		...
		for($i = 0; $i < $queue_count; $i++)
		{
			...
			$debug['passed'] = isset($passed) ? $passed : false;
	...
	{
		$mesh_format = new Vanilla_Validate_Format();
	...
	{
		$mesh_rule = new Vanilla_Validate_Rule();
