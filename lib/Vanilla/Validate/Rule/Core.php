 ...
 * @licence 	MIT
 */
abstract class Vanilla_Validate_Rule_Core {
	...
	{
		return (bool) ((Vanilla_Validate_Rule::min_length($value, $min_length)) && (Vanilla_Validate_Rule::max_length($value, $max_length)));
	}
